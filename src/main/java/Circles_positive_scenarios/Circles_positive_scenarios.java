...
public class Circles_positive_scenarios extends Generic_function {
	...
	public void circle_positive_tc_012() throws IOException  {
		try {
			click("welcome_login");
			page_wait(12);
			driver.findElement(By.xpath(OR_reader("Object_locator", "login_phone_number"))).sendKeys(td_reader("login_phone_number",1));
			driver.findElement(By.xpath(OR_reader("Object_locator", "login_password"))).sendKeys(td_reader("login_password",1));
			click("login");
			page_wait(20);
			click("circle_click");
